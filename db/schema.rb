...
ActiveRecord::Schema.define(version: 2020_03_02_030009) do
  ...
  create_table "cards", force: :cascade do |t|
    ...
    t.integer "value"
    t.integer "player_id"
    t.integer "parite_game_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["parite_game_id"], name: "index_cards_on_parite_game_id"
  ...
  add_foreign_key "cards", "parite_games"
